...
- ⚡ Fun fact: I still love watching Doremon
...
- [Islamic Legacy](https://play.google.com/store/apps/details?id=com.islamiclegacy.islamic_legacy&pcampaignid=web_share) : Developed a scalable Islamic mobile application using Flutter for the frontend and Python (Flask) for backend services.Built and integrated RESTful APIs to deliver accurate prayer times, Quran access, and daily Islamic knowledge in a clean,ad-free interface. Deployed and managed backend infrastructure on Amazon EC2, ensuring reliable performance and
high availability. Optimized application performance and user experience, achieving 1000+ downloads with consistent
user engagement and real-world usability validation.
